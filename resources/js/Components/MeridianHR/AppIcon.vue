...
const ICONS = {
  ...
  'user-check': `<circle cx="9" cy="8" r="4"/><path d="M3 21a8 8 0 0 1 13 0"/><path d="m17 11 2 2 4-4"/>`,
  ...
  link:       `<path d="M10 13a5 5 0 0 0 7.5 4.3l3-3a5 5 0 0 0-7-7l-1.5 1.5"/><path d="M14 11a5 5 0 0 0-7.5-4.3l-3 3a5 5 0 0 0 7 7l1.5-1.5"/>`,
  globe:      `<circle cx="12" cy="12" r="9"/><path d="M3 12h18M12 3a15 15 0 0 1 3 9 15 15 0 0 1-3 9 15 15 0 0 1-3-9 15 15 0 0 1 3-9"/>`,
  flag:       `<path d="M4 4v16"/><path d="M4 4s4 0 8 4c4-4 8-4 8-4v10s-4 0-8 4c-4-4-8-4-8-4Z"/>`,
  layers:     `<path d="m3 10 9 5 9-5-9-5Z"/><path d="m3 14 9 5 9-5"/><path d="m3 18 9 5 9-5"/>`,
  heart:      `<path d="M19 14c1.5-1.6 2-3.2 2-4.5A4.5 4.5 0 0 0 12.4 4 4.5 4.5 0 0 0 3 9.5c0 1.3.5 2.9 2 4.5L12 21Z"/>`,
  'map-pin':  `<path d="M12 2C8 2 5 5 5 9c0 5.3 7 13 7 13s7-7.7 7-13c0-4-3-7-7-7Z"/><circle cx="12" cy="9" r="2.5"/>`,
  'file-text': `<path d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8Z"/><path d="M14 3v5h5M9 9h1M9 13h6M9 17h6"/>`,
