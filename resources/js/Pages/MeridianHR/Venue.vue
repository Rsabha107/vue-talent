...
const form = useForm({ title: '', active_flag: getActiveStatusId() })
...
function addVenue() {
  form.post(route('hr.venues.store'), {
    onSuccess: () => {
...
function updateVenue() {
  editForm.put(route('hr.venues.update', editForm.id), {
...
function deleteVenue() {
  router.delete(route('hr.venues.destroy', venueToDelete.value.id), {
  ...
  <div @click="openMenuId = null">
    ...
    <div class="mhr-page-head">
      <div>
        ...
        <p class="mhr-page-head__sub">Manage venue locations</p>
      </div>
